...
HDCheck 		minimum free space on a filesystem in MB
			(string match on "df" command)
HDCheckGB 		minimum free space on a filesystem in GB
HDfreeMB		minimum free space on a filesystem in MB (mount point)
HDfreeGB		minimum free space on a filesystem in GB (mount point)
...
MemCheck		minimum free RAM (MB)
MemCheckLinux		minimum free RAM (MB) under Linux
...
SmartMonHealth		health status of hard discs (reads test state)
